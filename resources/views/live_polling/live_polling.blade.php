                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('store_live_polling') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6" style='margin-top:1%;'>
                                <input id="optionC" type="text" class="form-control @error('optionC') is-invalid @enderror" name="optionC" value="{{ old('optionC') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6" style='margin-top:1%;'>
                                <input id="optionD" type="text" class="form-control @error('optionD') is-invalid @enderror" name="optionD" value="{{ old('optionD') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6" style='margin-top:1%;'>
                                <input id="optionE" type="text" class="form-control @error('optionE') is-invalid @enderror" name="optionE" value="{{ old('optionE') }}" required autocomplete="name" autofocus>
