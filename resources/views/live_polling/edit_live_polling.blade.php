...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><b>Edit Live Poll {{ $live_pollings[0]->id }}</b></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('update_live_polling',$live_pollings[0]->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6" style='margin-top:1%;'>
                                <input id="optionC" type="text" class="form-control @error('optionC') is-invalid @enderror" name="optionC" value="{{ $live_pollings[0]->optionC }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6" style='margin-top:1%;'>
                                <input id="optionD" type="text" class="form-control @error('optionD') is-invalid @enderror" name="optionD" value="{{ $live_pollings[0]->optionD }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6" style='margin-top:1%;'>
                                <input id="optionE" type="text" class="form-control @error('optionE') is-invalid @enderror" name="optionE" value="{{ $live_pollings[0]->optionE }}" required autocomplete="name" autofocus>
